...
const STORAGE_KEYS = {
  TOURNAMENTS: 'charleston_golf_tournaments_v16',
  PLAYERS: 'charleston_golf_players_v16',
  USER_LOCATION: 'charleston_golf_location_v16',
  FILTERS: 'charleston_golf_filters_v16',
};
...
export function resetAllToDefaults(): { tournaments: Tournament[]; players: Player[]; location: UserLocation } {
  ...
  ['v1', 'v2', 'v3', 'v4', 'v5', 'v6', 'v7', 'v8', 'v9', 'v10', 'v11', 'v12', 'v13', 'v14', 'v15', 'v16'].forEach((v) => {
