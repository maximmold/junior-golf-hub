...
const STORAGE_KEYS = {
  TOURNAMENTS: 'charleston_golf_tournaments_v13',
  PLAYERS: 'charleston_golf_players_v13',
  USER_LOCATION: 'charleston_golf_location_v13',
  FILTERS: 'charleston_golf_filters_v13',
};
