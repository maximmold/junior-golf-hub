...
const STORAGE_KEYS = {
  TOURNAMENTS: 'charleston_golf_tournaments_v15',
  PLAYERS: 'charleston_golf_players_v15',
  USER_LOCATION: 'charleston_golf_location_v15',
  FILTERS: 'charleston_golf_filters_v15',
};
