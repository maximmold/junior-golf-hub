...
const STORAGE_KEYS = {
  TOURNAMENTS: 'charleston_golf_tournaments_v8',
  PLAYERS: 'charleston_golf_players_v8',
  USER_LOCATION: 'charleston_golf_location_v8',
  FILTERS: 'charleston_golf_filters_v8',
};
