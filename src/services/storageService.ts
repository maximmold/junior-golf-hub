...
const STORAGE_KEYS = {
  TOURNAMENTS: 'charleston_golf_tournaments_v14',
  PLAYERS: 'charleston_golf_players_v14',
  USER_LOCATION: 'charleston_golf_location_v14',
  FILTERS: 'charleston_golf_filters_v14',
};
